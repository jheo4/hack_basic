...
convert.out:     file format elf64-x86-64
...
00000000000005c0 <_start>:
 ...
 5cd:	50                   	push   %rax
 5ce:	54                   	push   %rsp
 5cf:	4c 8d 05 2a 02 00 00 	lea    0x22a(%rip),%r8        # 800 <__libc_csu_fini>
 5d6:	48 8d 0d b3 01 00 00 	lea    0x1b3(%rip),%rcx        # 790 <__libc_csu_init>
...
00000000000006ca <usage>:
 ...
 6dd:	48 8d 3d 34 01 00 00 	lea    0x134(%rip),%rdi        # 818 <_IO_stdin_used+0x8>
...
00000000000006f8 <main>:
 ...
 707:	83 7d ec 02          	cmpl   $0x2,-0x14(%rbp)
 70b:	7f 0f                	jg     71c <main+0x24>
 70d:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 711:	48 8b 00             	mov    (%rax),%rax
 714:	48 89 c7             	mov    %rax,%rdi
 717:	e8 ae ff ff ff       	callq  6ca <usage>
 71c:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 720:	48 83 c0 10          	add    $0x10,%rax
 724:	48 8b 00             	mov    (%rax),%rax
 727:	48 89 c7             	mov    %rax,%rdi
 72a:	e8 61 fe ff ff       	callq  590 <atoi@plt>
 72f:	89 45 fc             	mov    %eax,-0x4(%rbp)
 732:	8b 45 fc             	mov    -0x4(%rbp),%eax
 735:	89 c6                	mov    %eax,%esi
 737:	48 8d 3d 14 01 00 00 	lea    0x114(%rip),%rdi        # 852 <_IO_stdin_used+0x42>
 73e:	b8 00 00 00 00       	mov    $0x0,%eax
 743:	e8 38 fe ff ff       	callq  580 <printf@plt>
 748:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
 74f:	eb 25                	jmp    776 <main+0x7e>
 751:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
 755:	48 83 c0 08          	add    $0x8,%rax
 759:	48 8b 10             	mov    (%rax),%rdx
 75c:	8b 45 f8             	mov    -0x8(%rbp),%eax
 75f:	89 c6                	mov    %eax,%esi
 761:	48 8d 3d fc 00 00 00 	lea    0xfc(%rip),%rdi        # 864 <_IO_stdin_used+0x54>
 768:	b8 00 00 00 00       	mov    $0x0,%eax
 76d:	e8 0e fe ff ff       	callq  580 <printf@plt>
 772:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
 776:	8b 45 f8             	mov    -0x8(%rbp),%eax
 779:	3b 45 fc             	cmp    -0x4(%rbp),%eax
 77c:	7c d3                	jl     751 <main+0x59>
 77e:	90                   	nop
 77f:	c9                   	leaveq 
 780:	c3                   	retq   
...
0000000000000790 <__libc_csu_init>:
 ...
 7bc:	e8 97 fd ff ff       	callq  558 <_init>
