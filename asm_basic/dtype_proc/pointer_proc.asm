...
pointer_proc.out:     file format elf64-x86-64
...
0000000000400596 <main>:
  ...
  40059a:	48 83 ec 30          	sub    rsp,0x30
  ...
  4005b1:	48 ba 48 65 6c 6c 6f 	movabs rdx,0x77202c6f6c6c6548 # copy 64bits each time
  4005b8:	2c 20 77 
  4005bb:	48 89 10             	mov    QWORD PTR [rax],rdx
  4005be:	c7 40 08 6f 72 6c 64 	mov    DWORD PTR [rax+0x8],0x646c726f # copy remains(word%64bits)
  4005c5:	66 c7 40 0c 21 0a    	mov    WORD PTR [rax+0xc],0xa21
  4005cb:	c6 40 0e 00          	mov    BYTE PTR [rax+0xe],0x0
  4005cf:	48 8d 45 e0          	lea    rax,[rbp-0x20]
  4005d3:	48 89 45 d0          	mov    QWORD PTR [rbp-0x30],rax
  4005d7:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30] # x/s
  4005db:	48 83 c0 02          	add    rax,0x2
  4005df:	48 89 45 d8          	mov    QWORD PTR [rbp-0x28],rax
  4005e3:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] # x/s
  4005e7:	48 89 c7             	mov    rdi,rax
  4005ea:	b8 00 00 00 00       	mov    eax,0x0
  4005ef:	e8 7c fe ff ff       	call   400470 <printf@plt>
  4005f4:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] # x/s
  4005f8:	48 b9 79 20 79 6f 75 	movabs rcx,0x756720756f792079aa # copy 64bits each time
  4005ff:	20 67 75 
  400602:	48 89 08             	mov    QWORD PTR [rax],rcx
  400605:	c7 40 08 79 73 21 0a 	mov    DWORD PTR [rax+0x8],0xa217379a # copy remains(word%64bits)
  40060c:	c6 40 0c 00          	mov    BYTE PTR [rax+0xc],0x0
  400610:	48 8b 45 d0          	mov    rax,QWORD PTR [rbp-0x30] # x/s
  400614:	48 89 c7             	mov    rdi,rax
  400617:	b8 00 00 00 00       	mov    eax,0x0
  40061c:	e8 4f fe ff ff       	call   400470 <printf@plt>
  400621:	90                   	nop
  400622:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
  400626:	64 48 33 04 25 28 00 	xor    rax,QWORD PTR fs:0x28
  40062d:	00 00 
  40062f:	74 05                	je     400636 <main+0xa0>
  400631:	e8 2a fe ff ff       	call   400460 <__stack_chk_fail@plt>
  400636:	c9                   	leave  
  400637:	c3                   	ret    
  400638:	0f 1f 84 00 00 00 00 	nop    DWORD PTR [rax+rax*1+0x0]
  40063f:	00 
